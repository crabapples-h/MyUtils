...
public class SMSUtil {
    private static final String YOUXIN ="http://www.youxinyun.com:3070/Platform_Http_Service/servlet/SendSms";
    private static final String USERNAME ="nyfz";
    private static final String PASSWORD ="kdkj440520";
    ...
    public static String sendCodeYouXin(String phone,Integer mobile_code) {
        ...
        String json = getRequest(params,YOUXIN);
        return json;
  }
    
    public static String sendMeassageYouXin(String phone) {
    	Map<String,String> params = new HashMap<String,String>();//请求参数
    	String time = new SimpleDateFormat("MMddHHmmss").format(new Date());
    	params.put("UserName",USERNAME);
    	params.put("Timestemp",time);
